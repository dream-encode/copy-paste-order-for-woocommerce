...
class Copy_Paste_Order_For_Woocommerce_Upgrader {
	...
	public static function init() {
		...
		add_action( 'cpofw_run_update_callback', array( __CLASS__, 'run_update_callback' ) );
		add_action( 'cpofw_update_db_to_current_version', array( __CLASS__, 'update_db_version' ) );
	}
	...
	public static function check_version() {
		$plugin_version      = get_option( 'cpofw_plugin_version' );
		$plugin_code_version = COPY_PASTE_ORDER_FOR_WOOCOMMERCE_PLUGIN_VERSION;
	...
	private static function is_installing() {
		return 'yes' === get_transient( 'cpofw_installing' );
	}
	...
	public static function is_new_install() {
		return is_null( get_option( 'cpofw_plugin_version', null ) );
	}

<?php
/**
 * Class Copy_Paste_Order_For_Woocommerce_Abstract_Object_Data.
 *
 * @since 1.0.0
 */
...
if ( ! class_exists( 'Copy_Paste_Order_For_Woocommerce_Abstract_Object_Data' ) ) {

	/**
	 * Class Copy_Paste_Order_For_Woocommerce_Abstract_Object_Data
	 */
	abstract class Copy_Paste_Order_For_Woocommerce_Abstract_Object_Data {
		/**
		 * ID.
		 *
		 * @var int
			...
			if ( $errors ) {
				...
				throw new Exception(
					sprintf(
						...
						__( 'The following functions %1$s do not exists in %2$s', 'copy-paste-order-for-woocommerce' ),
						implode( ',', $errors ),
						get_class( $this )
					)
				);
